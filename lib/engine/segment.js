...
function segment(words, opts = {}) {
  return classifyPauses(flagUnits(segmentWords(words, opts), opts));
}

module.exports = { segment, segmentWords, flagUnits, classifyPauses, similarity, fillerRatio, DEFAULTS };
